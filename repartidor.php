...
<body>
        ...
        <div class="container container--flex">
          ...
          <nav class="main-nav" id="main-nav">
            <ul class="menu">
              ...
              <li class="menu__item"><a href="./pendientes.php" class="menu__link">Pendientes</a></li>
    ...
    <main class="main">
      <div class="container">
        <h2 class="main-title">Lista de Productos</h2>
        <section class="container-products">
          <div class="product">
            <img src="./img/imagen6.jpg" alt="" class="product__img">
              <div class="product__description">
              <h3 class="product__tittle">Productos</h3>
              <h3 class="product__tittle">Pendientes</h3>
                <span class="product__price">Ternos</span>
              </div>
            <a href="" class="product__icon fas fa-motorcycle"></a> 
          </div>
          <div class="product">
            <img src="./img/polo.jpg" alt="" class="product__img">
              ...
              <h3 class="product__tittle">Productos</h3>
              <h3 class="product__tittle">Pendientes</h3>
                <span class="product__price">Polos</span>
              </div>
            <a href="" class="product__icon fas fa-motorcycle"></a> 
          </div>
          <div class="product">
            <img src="./img/polera.jpg" alt="" class="product__img">
              ...
              <h3 class="product__tittle">Productos</h3>
              <h3 class="product__tittle">Pendientes</h3>
                <span class="product__price">Poleras</span>
              </div>
            <a href="" class="product__icon fas fa-motorcycle"></a> 
          </div>
          <div class="product">
            <img src="./img/saco.jpg" alt="" class="product__img">
              ...
              <h3 class="product__tittle">Productos</h3>
              <h3 class="product__tittle">Pendientes</h3>
                <span class="product__price">Sacos</span>
              </div>
            <a href="" class="product__icon fas fa-motorcycle"></a> 
          </div>
          <div class="product">
            <img src="./img/camisa.jpg" alt="" class="product__img">
              ...
              <h3 class="product__tittle">Productos</h3>
              <h3 class="product__tittle">Pendientes</h3>
                <span class="product__price">Camisas</span>
              </div>
            <a href="" class="product__icon fas fa-motorcycle"></a> 
          </div>
        <div class="product">
          ...
          <div class="product__description">
            <h3 class="product__tittle">Productos</h3>
            <h3 class="product__tittle">Pendientes</h3>
            <span class="product__price">Pantalones</span>
          </div>
          <a href="" class="product__icon fas fa-motorcycle"></a> 
        </div>
        <div class="product">
          ...
          <div class="product__description">
            <h3 class="product__tittle">Productos</h3>
            <h3 class="product__tittle">Pendientes</h3>
            <span class="product__price">Medias</span>
          </div>
          <a href="" class="product__icon fas fa-motorcycle"></a> 
        </div>
        <div class="product">
          ...
          <div class="product__description">
            <h3 class="product__tittle">Productos</h3>
            <h3 class="product__tittle">Pendientes</h3>
            <span class="product__price">Corbatas</span>
          </div>
          <a href="" class="product__icon fas fa-motorcycle"></a> 
        </div>
      </section>
